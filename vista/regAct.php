            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-4">
                    <div class=" bg-primary card card-outline-primary h-100">
                        ...
                        <h3 class="card-header bg-primary text-center text-white"><strong>REGISTRO DE ACTIVIDADES</strong></h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                                <form action="vista/jar_siea.php" method="post" rolo="form">
                                                            ...
                                                            <button type="submit" id="descJar" class="btn btn-block btn-warning" title="Descargar el .jar SIEA">
                                                                <img src="https://img.icons8.com/color/20/000000/java-coffee-cup-logo.png"><strong>SIEA</strong>
                                                            </button>
...
<script src="js/dina_regAct.js"></script>
